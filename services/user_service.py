...
class UserService:
    ...
    def __init__(self):
        ...
        self.con = get_db_connetion()  # Obtiene la conexión directamente
        if self.con is None:
    ...
    async def get_users(self):
        ...
        try:
            ...
            with self.con.cursor(pymysql.cursors.DictCursor) as cursor:
                ...
                users = cursor.fetchall() #cuando hay varios registros en la base de datos
    ...
    async def create_users(self, user_data: User):
        ...
        try:
            ...
            with self.con.cursor() as cursor:
                ...
                sql = "INSERT INTO usuario (nombre, apellido, correo, numtelefono, password, estado) VALUES (%s, %s, %s, %s, %s, %s)"
